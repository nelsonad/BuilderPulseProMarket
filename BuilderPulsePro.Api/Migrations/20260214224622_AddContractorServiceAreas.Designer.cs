...
namespace BuilderPulsePro.Api.Migrations
{
    ...
    [Migration("20260214224622_AddContractorServiceAreas")]
    partial class AddContractorServiceAreas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuilderPulsePro.Api.Domain.BidAttachment", b =>
                {
                    b.Property<Guid>("BidId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuilderPulsePro.Api.Domain.Conversation", b =>
                {
                    ...
                    b.HasIndex("JobId", "ContractorProfileId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BuilderPulsePro.Api.Domain.MessageAttachment", b =>
                {
            ...
            modelBuilder.Entity("BuilderPulsePro.Api.Domain.BidAttachment", b =>
                {
                    ...
                    b.HasOne("BuilderPulsePro.Api.Domain.Bid", null)
                        .WithMany()
                        .HasForeignKey("BidId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BuilderPulsePro.Api.Domain.MessageAttachment", b =>
                {
                    ...
                    b.HasOne("BuilderPulsePro.Api.Domain.Message", null)
                        .WithMany()
